// Exercice 4 :
// Écrivez un programme TypeScript qui déclare une variable sans spécifier son type et
// montre comment TypeScript infère le type en fonction de la valeur assignée.

let variable; // TypeScript inférera le type 'any' initialement
